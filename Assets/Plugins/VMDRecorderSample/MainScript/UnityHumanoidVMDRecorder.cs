...
public partial class UnityHumanoidVMDRecorder : MonoBehaviour
{
    ...
    private string WriteExportRotationDiagnosticsCsv(string vmdFilePath)
    {
        ...
        File.WriteAllText(csvPath, VmdExportDiagnosticsWriter.BuildExportRotationDiagnosticsCsv(exportRotationDiagnosticAggregatesSaved.Values), Encoding.UTF8);
        ...
        if (exportRotationDiagnosticSamplesSaved != null && exportRotationDiagnosticSamplesSaved.Count > 0)
        {
            ...
            File.WriteAllText(samplesCsvPath, VmdExportDiagnosticsWriter.BuildExportRotationDiagnosticSamplesCsv(exportRotationDiagnosticSamplesSaved), Encoding.UTF8);
    ...
    private string WriteExportIkSourceDiagnosticsCsv(string vmdFilePath)
    {
        ...
        File.WriteAllText(csvPath, VmdExportDiagnosticsWriter.BuildExportIkSourceDiagnosticsCsv(exportIkSourceDiagnosticSamplesSaved), Encoding.UTF8);
