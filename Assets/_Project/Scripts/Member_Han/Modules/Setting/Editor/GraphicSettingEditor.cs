...
namespace Member_Han.Modules.Graphics.EditorTools
{
    ...
    public static class GraphicSettingSceneInstaller
    {
        ...
        private static void ConfigureRecordingControls(RecodingSetting recodingSetting)
        {
            ...
            serialized.FindProperty("recordingFileManager").objectReferenceValue = fileManager;
            ...
            for (int i = button.onClick.GetPersistentEventCount() - 1; i >= 0; i--)
            {
                ...
                if (target == recodingSetting ||
                    ...
                    methodName == LegacyFileManagerManualRecordMethodName)
                {
        ...
        private static HumanoidSampleCode ResolveRecordingController(FileManager fileManager)
        {
