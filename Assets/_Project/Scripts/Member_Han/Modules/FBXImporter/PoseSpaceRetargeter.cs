...
namespace Member_Han.Modules.FBXImporter
{
    ...
    public class PoseSpaceRetargeter : MonoBehaviour
    {
        ...
        [Range(0f, 1f)]
        public float manualAnimatorRightLowerLegToFootSegmentDirectionReferenceBlendWeight = 1f;
        ...
        private void ApplyPostSetHumanPoseRightEndpointPositionReference()
        {
            ...
            Transform referenceHips = _editorFingerReferenceAnimator.GetBoneTransform(HumanBodyBones.Hips);
            Transform referenceFoot = _editorFingerReferenceAnimator.GetBoneTransform(HumanBodyBones.RightFoot);
            Transform targetHips = targetAnimator.GetBoneTransform(HumanBodyBones.Hips);
            Transform targetUpperLeg = targetAnimator.GetBoneTransform(HumanBodyBones.RightUpperLeg);
            Transform targetFoot = targetAnimator.GetBoneTransform(HumanBodyBones.RightFoot);
            Transform targetToes = targetAnimator.GetBoneTransform(HumanBodyBones.RightToes);
