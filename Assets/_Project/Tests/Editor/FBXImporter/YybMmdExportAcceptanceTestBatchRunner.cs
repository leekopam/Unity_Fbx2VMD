...
namespace Tests.Editor.FBXImporter
{
    public static class YybMmdExportAcceptanceTestBatchRunner
    {
        public static void Run()
        {
            ...
            RunTest(results, typeof(YybMmdExportSafetyDefaultsTests).FullName + "." +
                nameof(YybMmdExportSafetyDefaultsTests.Given_PreSetHumanPoseEndpointRuntimeOverride_When_Applied_Then_UsesSeparatePreSolveSwitchAndCaps),
                () => new YybMmdExportSafetyDefaultsTests().Given_PreSetHumanPoseEndpointRuntimeOverride_When_Applied_Then_UsesSeparatePreSolveSwitchAndCaps());
            RunTest(results, typeof(YybMmdExportSafetyDefaultsTests).FullName + "." +
                nameof(YybMmdExportSafetyDefaultsTests.Given_PreSetHumanPoseEndpointLeftSideRuntimeOverride_When_Applied_Then_PreservesPreSolveSideSwitch),
                () => new YybMmdExportSafetyDefaultsTests().Given_PreSetHumanPoseEndpointLeftSideRuntimeOverride_When_Applied_Then_PreservesPreSolveSideSwitch());
            RunTest(results, typeof(YybMmdExportSafetyDefaultsTests).FullName + "." +
                nameof(YybMmdExportSafetyDefaultsTests.Given_PreSetHumanPoseEndpointBodyPositionInversionRuntimeOverride_When_Applied_Then_PreservesAxisFlags),
                () => new YybMmdExportSafetyDefaultsTests().Given_PreSetHumanPoseEndpointBodyPositionInversionRuntimeOverride_When_Applied_Then_PreservesAxisFlags());
            RunTest(results, typeof(YybMmdExportSafetyDefaultsTests).FullName + "." +
                nameof(YybMmdExportSafetyDefaultsTests.Given_TargetHumanoidBonePositionLockRuntimeOverride_When_Toggled_Then_OnlyChangesSkeletonBasisLock),
                () => new YybMmdExportSafetyDefaultsTests().Given_TargetHumanoidBonePositionLockRuntimeOverride_When_Toggled_Then_OnlyChangesSkeletonBasisLock());
            RunTest(results, typeof(YybMmdExportSafetyDefaultsTests).FullName + "." +
                nameof(YybMmdExportSafetyDefaultsTests.Given_ManualAnimatorBodyPositionXzRuntimeOverride_When_Toggled_Then_OnlyChangesSolverBodyPositionBasis),
                () => new YybMmdExportSafetyDefaultsTests().Given_ManualAnimatorBodyPositionXzRuntimeOverride_When_Toggled_Then_OnlyChangesSolverBodyPositionBasis());
            RunTest(results, typeof(YybMmdExportSafetyDefaultsTests).FullName + "." +
